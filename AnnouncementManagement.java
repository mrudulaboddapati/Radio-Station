...
public class AnnouncementManagement extends BasePanel{
	...
	private void createComponents() {
		...
		tabbedPane.addTab("Add", new CreateAnnouncement());
		tabbedPane.addTab("Update", new UpdateAnnouncement());
		tabbedPane.addTab("Delete", new DeleteAnnouncement());
	...
	private void makeLayout() {
		...
		JLabel label = new JLabel("Announcement Management");
